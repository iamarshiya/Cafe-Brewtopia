    ...
    return (<section id="menu" className="py-24 md:py-32 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {drinks.map((drink, index) => (<div key={drink.id} className="group relative bg-card border border-border overflow-hidden shadow-soft hover:shadow-gold transition-all duration-700 animate-fade-in" style={{ animationDelay: `${index * 0.15}s` }}>
              {/* Image */}
        ...
        <div className="text-center mt-16">
          <a href="#" className="inline-flex items-center gap-3 text-primary hover:text-foreground text-xs tracking-[0.2em] uppercase transition-colors duration-500 group border-b border-primary/30 pb-2">
