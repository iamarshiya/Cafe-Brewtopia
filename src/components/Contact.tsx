        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto mb-16">
            <input
              ...
              required
              className="flex-1 h-14 px-6 bg-transparent border border-primary-foreground/30 text-primary-foreground placeholder:text-primary-foreground/40 focus:outline-none focus:border-primary-foreground/60 transition-all duration-500 text-sm tracking-wide"
            />
            <Button
              type="submit"
              variant="outline"
          ...
          <div className="flex items-center justify-center gap-6">
            ...
            {socialLinks.map((social) => (
              <a
                ...
                className="w-12 h-12 border border-primary-foreground/20 flex items-center justify-center text-primary-foreground/70 hover:border-primary-foreground/50 hover:text-primary-foreground transition-all duration-500"
              >
