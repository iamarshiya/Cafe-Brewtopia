...
const Menu = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Menu | Brewtopia Café</title>
        <meta name="description" content="Explore our full menu of artisan coffees, specialty teas, and fresh pastries at Brewtopia Café." />
      </Helmet>
