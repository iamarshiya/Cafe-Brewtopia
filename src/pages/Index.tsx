  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta name="keywords" content="coffee shop, artisan coffee, Portland cafe, espresso, latte, cold brew, breakfast, pastries" />
        <link rel="canonical" href="https://brewtopia.cafe" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Brewtopia - Artisan Coffee Shop in Portland" />
        <meta property="og:description" content="Your neighborhood spot for exceptional coffee and warm community vibes." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "name": "Brewtopia",
            "description": "Artisan coffee shop in downtown Portland offering handcrafted espresso drinks and fresh pastries",
            "address": {
              "@type": "PostalAddress",
