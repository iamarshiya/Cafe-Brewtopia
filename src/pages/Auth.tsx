...
const Auth = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    localStorage.setItem("brewtopia_user", JSON.stringify({ email: formData.email, name: formData.name || "Guest" }));
  ...
  return (
    <>
      <Helmet>
        <title>{isLogin ? "Sign In" : "Create Account"} - Brewtopia</title>
        <meta name="description" content="Sign in to your Brewtopia account to place orders and manage reservations." />
      </Helmet>
