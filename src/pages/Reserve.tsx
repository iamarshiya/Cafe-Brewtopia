...
const Reserve = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Reserve a Table - Brewtopia</title>
        <meta name="description" content="Reserve your table at Brewtopia. Experience our distinguished atmosphere and curated coffee collection." />
      </Helmet>
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="max-w-2xl mx-auto">
            ...
            {/* Form */}
            <form onSubmit={handleSubmit} className="space-y-8 bg-card border border-border p-8 md:p-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full h-10 px-3 bg-background border border-border text-foreground focus:border-primary focus:outline-none"
                  >
